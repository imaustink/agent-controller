...
| [0013](0013-copilot-swe-privileged-coding-tool.md) | A privileged `copilot-swe` tool wraps the agentic Copilot CLI to open pull requests; a single fine-grained PAT for model + git, deny-rule guardrails |
