 ...
 * ../markdown.ts), not the raw {@link Envelope} object -- easier for a user
 * to read and for the orchestrator's skill to edit. Wires in this tool's
 * stronger `sanitize` (redacts secrets, not just length-truncates) since
 * free-text fields may echo untrusted extracted content.
 */
